                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <nav class="nav flex-column side-nav">
                                <a class="nav-link active icon" href="my-profile.html" style="color:#156765; ">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <section>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="location" type="text" class="form-control" id="input-location2" placeholder="Your Location" value="" required>
                                            </div>
                                            <!--end form-group-->
                                            <div class="form-group">
                                        ...
                                        <section>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="email" type="email" class="form-control" id="email" placeholder="Your Email" value="">
                                            </div>
                                            <!--end form-group-->
                                        </section>
                                        ...
                                        <section>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="twitter" type="text" class="form-control" id="twitter" placeholder="http://" value="">
                                            </div>
                                            <!--end form-group-->
                                            <div class="form-group">
                                                <label for="facebook" class="col-form-label">Facebook</label>
                                                <input name="facebook" type="text" class="form-control" id="facebook" placeholder="http://" value="">
                                            </div>
                                            <!--end form-group-->
                                        </section>
